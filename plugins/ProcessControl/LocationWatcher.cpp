...
namespace {
const QString locationServiceName = QStringLiteral("com.lomiri.location.Service");
const QString locationObjectPath = QStringLiteral("/com/lomiri/location/Service");
